...
echo "=========================================================="
echo "There are two virtual environments already created: sci2 and sci3. the sci2 uses python2 while sci3 uses python3"
...
echo "$ source activate sci3"
echo "=========================================================="
echo "To create a new environment for a new project, you can run: "
echo ""
echo "$ conda create -n <project_name> python=2 #Use 2 for python version 2 and 3 for python version 3"
echo "$ source activate <project_name>"
echo "$ conda install <list of packages to install through conda>"
echo "$ pip install <list of packages to install through pip>"
echo ""
echo "=========================================================="
echo ""
